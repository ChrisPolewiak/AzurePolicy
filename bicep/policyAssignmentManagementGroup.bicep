...
// Allow per-assignment override of the MG where the definition lives (e.g. ANM policies
// deployed to a child MG rather than the root).  Falls back to the global parameter.
var effectiveDefMgId = assignment.?definitionManagementGroupId ?? definitionManagementGroupId
var policyDefinitionId = contains(assignment, 'policyDefinitionId')
  ? string(assignment.policyDefinitionId)
  : (targetsPolicyDefinition
    ? '/providers/Microsoft.Management/managementGroups/${effectiveDefMgId}/providers/Microsoft.Authorization/policyDefinitions/${assignment.policyDefinitionName}'
    : '/providers/Microsoft.Management/managementGroups/${effectiveDefMgId}/providers/Microsoft.Authorization/policySetDefinitions/${assignment.initiativeName}')
